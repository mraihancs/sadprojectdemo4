  ...
  <form style="width:30%;margin: auto;" action="home.php" method="POST" style="border:1px solid #ccc; margin-top: 80px;">
    <div class="container2">
      ...
      <div class="clearfix">
        ...
        <button style="width:100%;font-family: 'Dosis', sans-serif;" type="submit" name="submit" class="signupbtn"><a style="text-decoration: none;color:white;" href="signup.php">Sign Up</a></button>
